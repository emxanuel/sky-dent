...
const Financing = () => {
    return (
        <div className="flex flex-col items-center uppercase font-semibold gap-6 py-6">
            <p className="textBlue text-3xl scale-95 text-center flex flex-wrap items-center justify-center gap-4">
                ...
                <span className="flex">
                    ...
                    <span className="font-benedict font-normal text-black text-5xl">CASH</span>
                </span>
            </p>
